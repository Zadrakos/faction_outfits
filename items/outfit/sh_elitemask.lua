ITEM.name = "Elite Civil Protection Mask"
ITEM.model = Model("models/wn7new/metropolice/n7_cp_gasmask7.mdl")
	...
	OnRun = function(item)
        ...
        timer.Simple(0.1, function()
            if item:GetData("unitName") == nil then
                item:SetData("unitName", "C24:GPT⋮RCT." .. math.random(10000, 99999))
            end
